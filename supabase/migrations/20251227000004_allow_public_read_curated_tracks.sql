...
CREATE OR REPLACE FUNCTION "public"."cleanup_old_point_changes" ()
    RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cleanup_old_point_changes" () OWNER TO "postgres";

COMMENT ON FUNCTION "public"."cleanup_old_point_changes" () IS 'Remove resolved point changes older than 24 hours';

CREATE OR REPLACE FUNCTION "public"."cleanup_stale_editing_sessions" ()
    RETURNS integer
    LANGUAGE "plpgsql"
    AS $$
DECLARE
...
ALTER FUNCTION "public"."cleanup_stale_editing_sessions" () OWNER TO "postgres";

COMMENT ON FUNCTION "public"."cleanup_stale_editing_sessions" () IS 'Remove editing sessions without heartbeat for 5+ minutes';
...
CREATE TABLE IF NOT EXISTS "public"."curated_tracks" (
    ...
    CONSTRAINT "curated_tracks_confidence_check" CHECK ((("confidence" >= 1) AND ("confidence" <= 5))),
    CONSTRAINT "curated_tracks_source_check" CHECK (("source" = ANY (ARRAY['osm'::"text", 'rally'::"text", 'curated'::"text"])))
);

ALTER TABLE "public"."curated_tracks" OWNER TO "postgres";

COMMENT ON TABLE "public"."curated_tracks" IS 'Curated collection of off-road tracks from various sources';

COMMENT ON COLUMN "public"."curated_tracks"."confidence" IS 'Confidence level: 1=estimated, 2=satellite, 3=OSM, 4=community, 5=rally verified';

CREATE TABLE IF NOT EXISTS "public"."route_editing_sessions" (
    "id" "uuid" DEFAULT "gen_random_uuid" () NOT NULL,
...
ALTER TABLE ONLY "public"."route_editing_sessions" REPLICA IDENTITY
    FULL;

ALTER TABLE "public"."route_editing_sessions" OWNER TO "postgres";

COMMENT ON TABLE "public"."route_editing_sessions" IS 'Active editing sessions for real-time collaboration and presence tracking';

COMMENT ON COLUMN "public"."route_editing_sessions"."last_heartbeat" IS 'Updated every 30s by client to show active presence';

CREATE TABLE IF NOT EXISTS "public"."route_point_changes" (
    "id" "uuid" DEFAULT "gen_random_uuid" () NOT NULL,
    "route_id" "uuid" NOT NULL,
    "user_id" "uuid" NOT NULL,
    "user_email" "text" NOT NULL,
    ...
    "resolved_by" "uuid",
    CONSTRAINT "route_point_changes_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'accepted'::"text", 'rejected'::"text"])))
);

ALTER TABLE ONLY "public"."route_point_changes" REPLICA IDENTITY
    FULL;

ALTER TABLE "public"."route_point_changes" OWNER TO "postgres";

COMMENT ON TABLE "public"."route_point_changes" IS 'Realtime enabled: clients can subscribe to point change suggestions';

COMMENT ON COLUMN "public"."route_point_changes"."feature_index" IS 'Index of feature in MultiLineString (0-based)';

COMMENT ON COLUMN "public"."route_point_changes"."point_index" IS 'Index of point within the LineString (0-based)';
...
CREATE TABLE IF NOT EXISTS "public"."route_proposals" (
    ...
    "created_at" timestamp with time zone DEFAULT "now" () NOT NULL,
    "updated_at" timestamp with time zone DEFAULT "now" () NOT NULL,
    CONSTRAINT "route_proposals_status_check" CHECK (("status" = ANY (ARRAY['pending'::"text", 'accepted'::"text", 'rejected'::"text"])))
);

ALTER TABLE ONLY "public"."route_proposals" REPLICA IDENTITY
    FULL;

ALTER TABLE "public"."route_proposals" OWNER TO "postgres";

COMMENT ON TABLE "public"."route_proposals" IS 'Realtime enabled: clients can subscribe to proposal changes';
...
ALTER TABLE ONLY "public"."route_versions" REPLICA IDENTITY
    FULL;

ALTER TABLE "public"."route_versions" OWNER TO "postgres";

COMMENT ON TABLE "public"."route_versions" IS 'Realtime enabled: clients can subscribe to geometry updates';
...
ALTER TABLE ONLY "public"."routes" REPLICA IDENTITY
    FULL;

ALTER TABLE "public"."routes" OWNER TO "postgres";

COMMENT ON TABLE "public"."routes" IS 'Realtime enabled: clients can subscribe to route list changes';

COMMENT ON COLUMN "public"."routes"."owner_id" IS 'UUID of the user who owns this route (from JWT sub claim)';

ALTER TABLE ONLY "public"."curated_tracks"
    ADD CONSTRAINT "curated_tracks_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."route_editing_sessions"
    ADD CONSTRAINT "route_editing_sessions_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."route_editing_sessions"
    ADD CONSTRAINT "route_editing_sessions_route_id_user_id_key" UNIQUE ("route_id", "user_id");

ALTER TABLE ONLY "public"."route_point_changes"
    ADD CONSTRAINT "route_point_changes_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."route_proposals"
    ADD CONSTRAINT "route_proposals_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."route_versions"
    ADD CONSTRAINT "route_versions_pkey" PRIMARY KEY ("id");

ALTER TABLE ONLY "public"."routes"
    ADD CONSTRAINT "routes_pkey" PRIMARY KEY ("id");

CREATE INDEX "idx_curated_tracks_confidence" ON "public"."curated_tracks" USING "btree" ("confidence");

CREATE INDEX "idx_curated_tracks_geometry" ON "public"."curated_tracks" USING "gist" ("geometry");

CREATE INDEX "idx_curated_tracks_region" ON "public"."curated_tracks" USING "btree" ("region");

CREATE INDEX "idx_curated_tracks_source" ON "public"."curated_tracks" USING "btree" ("source");

CREATE INDEX "idx_route_editing_sessions_last_heartbeat" ON "public"."route_editing_sessions" USING "btree" ("last_heartbeat");

CREATE INDEX "idx_route_editing_sessions_route_id" ON "public"."route_editing_sessions" USING "btree" ("route_id");

CREATE INDEX "idx_route_editing_sessions_user_id" ON "public"."route_editing_sessions" USING "btree" ("user_id");

CREATE INDEX "idx_route_point_changes_route_id" ON "public"."route_point_changes" USING "btree" ("route_id");

CREATE INDEX "idx_route_point_changes_route_status" ON "public"."route_point_changes" USING "btree" ("route_id", "status");

CREATE INDEX "idx_route_point_changes_status" ON "public"."route_point_changes" USING "btree" ("status");

CREATE INDEX "idx_route_point_changes_user_id" ON "public"."route_point_changes" USING "btree" ("user_id");

CREATE INDEX "idx_route_proposals_created_by" ON "public"."route_proposals" USING "btree" ("created_by");

CREATE INDEX "idx_route_proposals_route_id" ON "public"."route_proposals" USING "btree" ("route_id");

CREATE INDEX "idx_route_proposals_status" ON "public"."route_proposals" USING "btree" ("status");

CREATE INDEX "idx_route_versions_created_at" ON "public"."route_versions" USING "btree" ("created_at" DESC);

CREATE INDEX "idx_route_versions_route_created" ON "public"."route_versions" USING "btree" ("route_id", "created_at" DESC);

CREATE INDEX "idx_route_versions_route_id" ON "public"."route_versions" USING "btree" ("route_id");

CREATE INDEX "idx_routes_owner_id" ON "public"."routes" USING "btree" ("owner_id");

CREATE INDEX "idx_routes_updated_at" ON "public"."routes" USING "btree" ("updated_at" DESC);

CREATE OR REPLACE TRIGGER "update_curated_tracks_updated_at"
    BEFORE UPDATE ON "public"."curated_tracks"
    FOR EACH ROW
    EXECUTE FUNCTION "public"."update_updated_at_column" ();

CREATE OR REPLACE TRIGGER "update_route_point_changes_updated_at"
    BEFORE UPDATE ON "public"."route_point_changes"
    FOR EACH ROW
    EXECUTE FUNCTION "public"."update_updated_at_column" ();

CREATE OR REPLACE TRIGGER "update_route_proposals_updated_at"
    BEFORE UPDATE ON "public"."route_proposals"
    FOR EACH ROW
    EXECUTE FUNCTION "public"."update_updated_at_column" ();
...
ALTER TABLE ONLY "public"."route_editing_sessions"
    ADD CONSTRAINT "route_editing_sessions_route_id_fkey" FOREIGN KEY ("route_id") REFERENCES "public"."routes" ("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."route_point_changes"
    ADD CONSTRAINT "route_point_changes_route_id_fkey" FOREIGN KEY ("route_id") REFERENCES "public"."routes" ("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."route_proposals"
    ADD CONSTRAINT "route_proposals_route_id_fkey" FOREIGN KEY ("route_id") REFERENCES "public"."routes" ("id") ON DELETE CASCADE;

ALTER TABLE ONLY "public"."route_versions"
    ADD CONSTRAINT "route_versions_route_id_fkey" FOREIGN KEY ("route_id") REFERENCES "public"."routes" ("id") ON DELETE CASCADE;

CREATE POLICY "Allow all authenticated users to see all route versions" ON "public"."route_versions"
...
CREATE POLICY "Allow all authenticated users to see all routes" ON "public"."routes"
    FOR SELECT TO "authenticated"
        USING (TRUE);

CREATE POLICY "Anyone can view curated tracks" ON "public"."curated_tracks"
    FOR SELECT TO "authenticated", "anon"
        USING (TRUE);

CREATE POLICY "Owner create route versions" ON "public"."route_versions"
    FOR INSERT
        WITH CHECK ((EXISTS (
            SELECT
                1
            FROM
                "public"."routes"
            WHERE (("routes"."id" = "route_versions"."route_id") AND ("routes"."owner_id" = "auth"."uid" ())))));

CREATE POLICY "Owners update point changes" ON "public"."route_point_changes"
    FOR UPDATE
        USING ((EXISTS (
            SELECT
                1
            FROM
                "public"."routes"
            WHERE (("routes"."id" = "route_point_changes"."route_id") AND ("routes"."owner_id" = "auth"."uid" ())))));

CREATE POLICY "Owners update proposals" ON "public"."route_proposals"
    FOR UPDATE
        USING ((EXISTS (
            SELECT
                1
            FROM
                "public"."routes"
            WHERE (("routes"."id" = "route_proposals"."route_id") AND ("routes"."owner_id" = "auth"."uid" ())))));

CREATE POLICY "Public read curated tracks" ON "public"."curated_tracks"
    FOR SELECT
        USING (TRUE);

CREATE POLICY "Users create point changes" ON "public"."route_point_changes"
    FOR INSERT
        WITH CHECK (("user_id" = "auth"."uid" ()));

CREATE POLICY "Users create proposals" ON "public"."route_proposals"
    FOR INSERT
        WITH CHECK (("created_by" = "auth"."uid" ()));

CREATE POLICY "Users create routes" ON "public"."routes"
    FOR INSERT
        WITH CHECK (("owner_id" = "auth"."uid" ()));

CREATE POLICY "Users delete own routes" ON "public"."routes"
    FOR DELETE
        USING (("owner_id" = "auth"."uid" ()));

CREATE POLICY "Users manage own session" ON "public"."route_editing_sessions"
    USING (("user_id" = "auth"."uid" ()))
    WITH CHECK (("user_id" = "auth"."uid" ()));

CREATE POLICY "Users read point changes for owned routes or own changes" ON "public"."route_point_changes"
    FOR SELECT
...
CREATE POLICY "Users read proposals for owned routes or created ones" ON "public"."route_proposals"
    FOR SELECT
...
CREATE POLICY "Users see sessions for owned or joined routes" ON "public"."route_editing_sessions"
    FOR SELECT
        USING ((("user_id" = "auth"."uid" ()) OR (EXISTS (
            SELECT
                1
            FROM
                "public"."routes"
            WHERE (("routes"."id" = "route_editing_sessions"."route_id") AND ("routes"."owner_id" = "auth"."uid" ()))))));

CREATE POLICY "Users update own routes" ON "public"."routes"
    FOR UPDATE
        USING (("owner_id" = "auth"."uid" ()));

ALTER TABLE "public"."curated_tracks" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."route_editing_sessions" ENABLE ROW LEVEL SECURITY;

ALTER TABLE "public"."route_point_changes" ENABLE ROW LEVEL SECURITY;
...
ALTER PUBLICATION "supabase_realtime"
    ADD TABLE ONLY "public"."route_editing_sessions";

ALTER PUBLICATION "supabase_realtime"
    ADD TABLE ONLY "public"."route_point_changes";

ALTER PUBLICATION "supabase_realtime"
    ADD TABLE ONLY "public"."route_versions";

ALTER PUBLICATION "supabase_realtime"
    ADD TABLE ONLY "public"."routes";
...
GRANT ALL ON FUNCTION "public"."cleanup_old_point_changes" () TO "anon";

GRANT ALL ON FUNCTION "public"."cleanup_old_point_changes" () TO "authenticated";

GRANT ALL ON FUNCTION "public"."cleanup_old_point_changes" () TO "service_role";

GRANT ALL ON FUNCTION "public"."cleanup_stale_editing_sessions" () TO "anon";

GRANT ALL ON FUNCTION "public"."cleanup_stale_editing_sessions" () TO "authenticated";

GRANT ALL ON FUNCTION "public"."cleanup_stale_editing_sessions" () TO "service_role";
...
GRANT ALL ON TABLE "public"."curated_tracks" TO "anon";

GRANT ALL ON TABLE "public"."curated_tracks" TO "authenticated";

GRANT ALL ON TABLE "public"."curated_tracks" TO "service_role";

GRANT ALL ON TABLE "public"."route_editing_sessions" TO "anon";

GRANT ALL ON TABLE "public"."route_editing_sessions" TO "authenticated";

GRANT ALL ON TABLE "public"."route_editing_sessions" TO "service_role";

GRANT ALL ON TABLE "public"."route_point_changes" TO "anon";

GRANT ALL ON TABLE "public"."route_point_changes" TO "authenticated";

GRANT ALL ON TABLE "public"."route_point_changes" TO "service_role";

GRANT ALL ON TABLE "public"."route_proposals" TO "anon";

GRANT ALL ON TABLE "public"."route_proposals" TO "authenticated";

GRANT ALL ON TABLE "public"."route_proposals" TO "service_role";

GRANT ALL ON TABLE "public"."route_versions" TO "anon";

GRANT ALL ON TABLE "public"."route_versions" TO "authenticated";

GRANT ALL ON TABLE "public"."route_versions" TO "service_role";
